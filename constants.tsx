...
export const TEMPLATES: Template[] = [
  {
    ...
    designData: assignLayer({
      pPanel: { id: "pPanel", type: ToolType.Rect, x: 0, y: 0, width: 343, height: 600, fill: themeColors.primary, fillThemeColor: 'primary', stroke: "none", zIndex: 10, edit: true, seal: false, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, linkedObj: null },
      sPanel: { id: "sPanel", type: ToolType.Rect, x: 343, y: 0, width: 457, height: 600, fill: themeColors.secondary, fillThemeColor: 'secondary', stroke: "none", zIndex: 10, edit: true, seal: false, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, linkedObj: null },
  ...
  },
  {
    ...
    layers: defaultLayers,
    designData: assignLayer({
        pPanel: { id: "pPanel", type: ToolType.Rect, x: 0, y: 0, width: 338, height: 600, fill: themeColors.primary, fillThemeColor: 'primary', stroke: "none", zIndex: 10, edit: true, seal: false, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, linkedObj: null },
        sPanel: { id: "sPanel", type: ToolType.Rect, x: 347, y: 0, width: 453, height: 600, fill: themeColors.secondary, fillThemeColor: 'secondary', stroke: "none", zIndex: 10, edit: true, seal: false, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, linkedObj: null },
  ...
  },
  {
    ...
    designData: assignLayer({
      background: { id: "background", type: ToolType.Rect, x: 0, y: 0, width: 600, height: 800, fill: themeColors.tertiary, fillThemeColor: 'tertiary', stroke: "none", zIndex: 10, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
      bPanel: { id: "bPanel", type: ToolType.Rect, x: 0, y: 629, width: 600, height: 171, fill: themeColors.primary, fillThemeColor: 'primary', stroke: "none", zIndex: 11, edit: true, seal: false, strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, linkedObj: null },
      ...
      img5: { id: "img5", type: ToolType.Image, x: 250, y: 265, width: 100, height: 100, zIndex: 30, linkedObj: "img5Box", themeImage: "primary", fill: null, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false },
      img5Box: { id: "img5Box", type: ToolType.Rect, photobox: true, x: 250, y: 265, width: 100, height: 100, zIndex: 31, fill: themeColors.tertiary, fillThemeColor: 'tertiary', borderRadius: 50, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: 'img5' },
    }),
  },
  {
    ...
    layers: defaultLayers,
    designData: assignLayer({
        bg: { id: "bg", type: ToolType.Rect, x: 0, y: 0, width: 800, height: 600, fill: themeColors.tertiary, fillThemeColor: 'tertiary', zIndex: 10, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
        pPanel: { id: "pPanel", type: ToolType.Rect, x: 29, y: 25, width: 357, height: 550, fill: themeColors.primary, fillThemeColor: 'primary', zIndex: 11, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
        sPanel: { id: "sPanel", type: ToolType.Rect, x: 414, y: 25, width: 357, height: 550, fill: themeColors.secondary, fillThemeColor: 'secondary', zIndex: 11, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
  ...
  },
  {
    ...
    designData: assignLayer({
      ...
      bg: { id: "bg", type: ToolType.Rect, x: 11, y: 10, width: 777, height: 580, fill: themeColors.tertiary, fillThemeColor: 'tertiary', zIndex: 11, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
      sPanel: { id: "sPanel", type: ToolType.Rect, x: 11, y: 10, width: 389, height: 580, fill: themeColors.secondary, fillThemeColor: 'secondary', zIndex: 12, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
  ...
  },
  {
    ...
    designData: assignLayer({
      bg: { id: "bg", type: ToolType.Rect, x: 0, y: 0, width: 800, height: 600, fill: themeColors.tertiary, fillThemeColor: 'tertiary', zIndex: 10, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
      deco: { id: "deco", type: ToolType.Ellipse, x: 64, y: 50, width: 100, height: 100, fill: themeColors.secondary, fillThemeColor: 'secondary', fillOpacity: 0.5, stroke: "none", zIndex: 15, strokeWidth: 0, strokeOpacity: 1, edit: true, seal: false, linkedObj: null },
  ...
  },
  {
    ...
    layers: defaultLayers,
    designData: assignLayer({
      bg: { id: "bg", type: ToolType.Rect, x: 0, y: 0, width: 600, height: 800, fill: themeColors.tertiary, fillThemeColor: 'tertiary', zIndex: 5, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
      ...
      sPanel: { id: "sPanel", type: ToolType.Rect, x: 50, y: 600, width: 500, height: 150, fill: themeColors.secondary, fillThemeColor: 'secondary', zIndex: 20, stroke: 'none', strokeWidth: 0, strokeOpacity: 1, fillOpacity: 1, edit: true, seal: false, linkedObj: null },
